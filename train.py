...
def load_CIFAR10(args, val_split=0.2):
    ...
    if args.distributed:
        if hasattr(args, "ra_sampler") and args.ra_sampler:
            train_sampler = RASampler(train_ds, shuffle=True, repetitions=args.ra_reps)
        else:
    ...
    return train_ds, test_dataset, train_sampler, test_sampler
